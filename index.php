...
<html lang="en">
  <head>
    ...
    <title>Best Food Cafe &amp; Restaurant | Free Bootstrap Website Template</title>
    <!-- Web app manifest -->
  ...
  <body id="top">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div class="collapse navbar-collapse text-center" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="table.php">Book Table</a>
            </li>

          </ul>
          <div class="ml-auto">
            <a class="nav-social mr-2" href="https://www.facebook.com/c.dark96/"><i class="fa fa-facebook" aria-hidden="true"></i></a>
            <a class="nav-social mr-2" href="https://github.com/Chamiiya"><i class="fa fa-tripadvisor" aria-hidden="true"></i></a>
            <a class="nav-social mr-2" href="https://www.instagram.com/chamiiya_/?hl=en"><i class="fa fa-instagram" aria-hidden="true"></i></a>
            <a class="nav-social" href="https://github.com/Chamiiya"><i class="fa fa-envelope" aria-hidden="true"></i></a>
          </div>
        </div>
      </nav>
    </header>
        ...
        <div class="carousel-inner">
          <div class="dark-overlay carousel-item active">
            ...
            <div class="carousel-caption">
              <h1 class="brand-title display-2 animated fadeInDown">Best Food</h1>
              <h4 class="brand-description animated fadeInDown">CAFE &amp; RESTAURANT</h4>
              <a class="mt-3 btn btn-light animated fadeInUp" href="table.php" role="button">BOOK TABLE NOW</a>
            </div>
          </div>
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                ...
                <blockquote>
                  ...
                  <footer class="blockquote-footer">chamith Rajapaksha, <cite title="Source Title"><a href="https://github.com/Chamiiya">Trip Advisor</a></cite></footer>
                </blockquote>
              </div>
              <div class="carousel-item">
                ...
                <blockquote>
                  ...
                  <footer class="blockquote-footer">Dilshan Jayathilaka, <cite title="Source Title"><a href="https://github.com/Chamiiya">Trip Advisor</a></cite></footer>
                </blockquote>
              </div>
              <div class="carousel-item">
                <img 
                ...
                <blockquote>
                  ...
                  <footer class="blockquote-footer">Kandula Kaveen, <cite title="Source Title"><a href="https://github.com/Chamiiya">Trip Advisor</a></cite></footer>
                </blockquote>
              </div>
              <div class="carousel-item">
                <img 
                  src="img/the-crispy-bird.jpg"
                  srcset="
                  img/the-crispy-bird.jpg 1x, 
                  img/the-crispy-bird.jpg 2x,
                  img/the-crispy-bird.jpg 3x"
                  alt="Testimonial"
                  class="d-block mx-auto rounded-circle img-thumbnail">
                <blockquote>
                  <p class="mb-0">
                  ...
                  <footer class="blockquote-footer">Shenal Wijewardana, <cite title="Source Title"><a href="https://github.com/Chamiiya">Trip Advisor</a></cite></footer>
                </blockquote>
              </div>
            </div>
    ...
    <footer class="page-footer">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-3 h-100 border-left-custom">
            ...
            <address>
              BestFood &amp; Seafood Restaurant<br>
              11 Kandalama,Dambulla.<br>
              21106<br>
              <abbr title="Phone">P:</abbr> (+94) 76-7949254<br>
              <abbr title="Email">E:</abbr> info@BestFood.com<br>
            </address>
          </div>
          <div class="col-md-3 h-100 border-left-custom">
            <h5 class="page-footer-title mt-3 mt-md-0">FOLLOW US</h5>
            <div class="mb-3">
              <a class="footer-social" href="https://www.facebook.com/c.dark96/" aria-label="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a>
              <a class="footer-social" href="https://github.com/Chamiiya" aria-label="tripadvisor"><i class="fa fa-tripadvisor" aria-hidden="true"></i></a>
              <a class="footer-social" href="https://www.instagram.com/chamiiya_/?hl=en" aria-label="instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a>
            </div>
          </div>
          <div class="col-md-3 h-100 border-left-custom">
            ...
            <p>
              ...
              news and special offers at BestFood.
            </p>
      ...
      <div class="page-footer-copyright container-fluid text-center">
        © 2024 Best Food Cafe &amp; Restaurant. All rights reserved.<br>
        Design &amp; Development by <a href="https://www.facebook.com/chalana.anantha.5">Chalana</a> (Chalana Anantha Ashinshana).
      </div>
    </footer>
